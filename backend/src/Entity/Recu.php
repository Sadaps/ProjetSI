...
class Recu
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['produit:read'])] // On veut voir l'ID du reçu
    private ?int $id = null;

    #[ORM\Column]
    #[Groups(['produit:read'])] // On veut voir combien on a reçu
    private ?int $quantite = null;

    #[ORM\Column(type: Types::DATE_MUTABLE)]
    #[Groups(['produit:read'])] // On veut voir quand
    ...
    public function getDateReception(): ?\DateTime { return $this->date_reception; }
    public function setDateReception(\DateTime $date_reception): static { $this->date_reception = $date_reception; return $this; }
